...
def main_loop():
    ...
    while running:
        ...
        if gs.checkmate:
            ...
            gameOver = True
            finisher(screen, "raventsvo")

        clock.tick(MAX_FPS)
        p.display.flip()
       
def draw_game_state(screen, gs, valid_moves, sq_attacked):
    draw_board(screen)
    cur_sq(screen, gs, valid_moves, sq_attacked)
    draw_pieces(screen, gs.board)

def cur_sq(screen, gs, valid_moves, square_selected):
